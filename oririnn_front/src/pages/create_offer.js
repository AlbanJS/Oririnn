...
function Offer() {
    ...
    const [offer, setOffer] = useState({ title: "", adress: "", code: "", city: "", description: "", start: "", end: "", capacity: "", price: "" })
                ...
                <div className={style.choosen}>
                    ...
                    <div className={`${style.block} ${style.roomBlock}`}>
                        ...
                        <div className={style.price}>
                            <p>Prix de la nuit  *:</p>
                            <input type="price" onInput={e => setOffer({ ...offer, price: e.target.value })}></input>
                        </div>
                    </div>
                </div>
